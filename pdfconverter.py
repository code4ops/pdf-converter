...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--download', type=str, help='URL from where to download PDF file', default='')
    parser.add_argument('--save-path', type=str, help='Path where to save downloaded PDF file. Default is /tmp', default='/tmp')
